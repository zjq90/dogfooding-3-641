...
public class BorrowerController {
    ...
    public Result<PageResult<Borrower>> getBorrowerPage(
        ...
        PageResult<Borrower> result = borrowerService.getBorrowerPage(page, size, name, phone, status);
    ...
    public Result<Void> addBorrower(@RequestBody Borrower borrower) {
        ...
        if (borrower.getPhone() == null || borrower.getPhone().trim().isEmpty()) {
    ...
    public Result<Void> deleteBorrower(@PathVariable Long id) {
        ...
        boolean success = borrowerService.removeById(id);
        if (success) {
